...
export const FICTION_CHAPTER_AI_SLOP_WORDS = [
  "tapestry",
  "kaleidoscope",
  "testament",
  "cascade",
  ...
  "unyielding",
  "cascade (as metaphor)",
  "symphony (as metaphor for non-music)",
  "beacon (as metaphor)",
  "labyrinthine",
  "resonated (emotional context)",
  "intertwined (emotional context)",
] as const;

export const FICTION_CHAPTER_AI_SLOP_PHRASES = [
  "a testament to",
  "testament to the power of",
  "a kaleidoscope of",
  "kaleidoscope of colors/emotions",
  "a tapestry of",
  "tapestry of light/color/sound",
  "a symphony of",
  "symphony of light/color/sound",
  "a cascade of",
  "cascade of emotions/colors/light",
  "a beacon of hope",
  "a crucible of",
  "forged in the crucible of",
  "the weight of [abstract noun] settled",
  "a [adjective] mix of [emotion] and [emotion]",
  "she felt the first stirrings of [emotion]",
  "something shifted in/within [character]",
  "the air was thick with [abstract quality]",
  "the world seemed to [personification verb]",
  "alone but undaunted",
  "alone but not alone",
  "stepped into the [abstract noun]",
  "walked toward [her/his/their] destiny",
  "[character] was not just surviving; [character] was living",
  "the journey was just beginning",
  "and that was just the beginning",
  "little did [they] know",
  "a new chapter in [their] life",
  "the [noun] that [they] didn't know [they] needed",
  "in that moment, [character] understood",
  "as if the [planet/world/universe] itself",
  "a language that transcended [words/species/boundaries]",
  "a beacon of light",
  "forged in the crucible",
  "the weight of [his/her/their] [noun] settled",
  "in that moment [character] understood",
  "in that moment [character] knew",
  "in that moment [character] realized",
  "something shifted within",
  "something shifted in [character]",
  "the air was thick with",
  "the air was heavy with",
  "as if the world itself",
  "as if the planet itself",
  "as if the universe itself",
  "a language that transcended",
  ...
  "eyes widened in",
  "jaw tightened",
  "breath [they] didn't know [they'd] been holding",
  ...
  "found [themselves] smiling",
  "found [themselves] wondering",
  "a [adjective] reminder",
  "words hung in the air",
  "the words tumbled out",
  "let out a breath",
  "the question hung between them",
  "the realization hit [them] like",
  "it hit [them] like a",
  ...
  "and with that",
  "the world seemed to",
  "the [journey/adventure/path] had just begun",
  "walked toward [their] destiny",
  "stepped into the future",
  "stepped into the unknown",
  "the road ahead",
  "the path ahead was uncertain",
  "[they] were not just surviving",
  "against the vast tableau",
  "beneath the watchful gaze of",
  "painted [the/their] path",
  "a living testament",
  "cemented the alliance/bond",
...
export const NONFICTION_AI_SLOP_PHRASES = [
...
export function renderBannedPhrasesBlock(
  ...
  if (appliesTo === "fiction") {
    ...
    let out =
      CHAPTER_FICTION_SLOP_PREFIX +
      `## BANNED AI-DEFAULT DICTION FOR FICTION CHAPTERS\n` +
      `These words are high-probability LLM defaults. Never use the following more than once per chapter, and only if the exact sentence genuinely earns it. The words tapestry, kaleidoscope, symphony, cascade, testament, beacon, and crucible should appear ZERO times:\n` +
      FICTION_CHAPTER_AI_SLOP_WORDS.map((word) => `- ${word}`).join("\n") +
      `\n\n## ABSOLUTELY BANNED AI-SLOP PHRASES\n` +
      `Do not use these exact phrases or close variants. Replace them with concrete action, pressure, dialogue, or sensory evidence:\n` +
      FICTION_CHAPTER_AI_SLOP_PHRASES.map((phrase) => `- "${phrase}"`).join("\n") +
      `\n`;
    let i = 0;
    for (const r of rows) {
  ...
  if (appliesTo === "non_fiction") {
    ...
    return (
      `BANNED NON-FICTION AI-SLOP PHRASES\n` +
      `Do not use these phrases or close variants. Replace them with a specific claim, scene, case, cost, or argument move:\n` +
      NONFICTION_AI_SLOP_PHRASES.map((phrase) => `- "${phrase}"`).join("\n") +
